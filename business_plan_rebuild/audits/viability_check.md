# Financial Viability Audit

## Executive Summary
**Status: VIABLE but TIGHT.**
...
## 2. Cost Realism
*   **Labor (25k Driver):** **REALISTIC.** Standard delivery drivers earn 15-18k. Paying 25k ensures "Service Mindset" (uniforms, polite) required for premium condos.
*   **Vehicle (28k Lease):** **REALISTIC.** Used Isuzu NPRs cost ~500k. A commercial lease/finance payment is ~15-20k. 28k allows for insurance + maintenance buffer.
*   **Fuel (6k/month):** **CONSERVATIVE.** At 30 THB/L diesel, this buys 200L (1,600 km). A 5km cluster route uses <500 km/month. Ample buffer.

## 3. Targets & Upside
*   **Profit Target (60k @ 9 Bldgs):** **ACHIEVABLE.**
    *   Revenue: 324k (9 * 36k).
    *   Fixed Costs: ~150k.
    *   Variable: ~100k.
    *   Net: ~70k.
*   **Hidden Upside:** The model assumes **0 THB** from material sales.
    *   Reality: 3,600 units * 2kg/mo * 10 THB/kg (PET price) = **72,000 THB/month** in pure margin upside.
